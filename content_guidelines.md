...
This is a less strict one I guess, and is more a suggestion than a rule. If I say something in **bold**, **UNDERLINED *~~ITALIC~~* BIG LETTERS** “**DO/NOT DO** *X*”, then *probably* treat *that* as a rule.

* **Bluesky**: Announcement posts (such as a new video coming out, a new server, etc) and silly replies and interactions;  
* **YouTube**: Long-form content/Landscape content, such as tours, ads, “historical archives” and series/shows;  
* **TikTok/Reels/Stories**: Short and long-form content adapted to portrait mode, be it with special editing and/or scaled to fit with a gaussian blur of the video as the background;  
* **Instagram (feed)**: *Really* short videos, screenshots, or slides.

**We will not be using YouTube shorts at all in the near future.**

# What to avoid

These are things you should avoid at all costs when making any form of content to be posted in CRSS’ profiles. These don't apply to anything inside the server, you can go wild in there as long as you're not breaking *server* rules.

* Swearing  
  * **DO NOT** say or write (in editing) ***any*** form of cursing whatsoever. Not allowed in audio, not allowed in text, not allowed in morse, not allowed in SSTV.  
  * Any text in the server, for example in signs, is allowed to be kept. Intentionally placing signs to bypass this is not allowed.  
* NSFW content or implications  
  * This is strictly prohibited for obvious reasons. Not only that kind of content is against the terms of most if not all platforms we're on, and is an extremely immature topic for humour, we're almost all minors. Nothing of this nature will be tolerated.  
  * The only exceptions are the “upside down T’s” present in both servers and the signs in them.  
...
Ads in CRSS content are non-commercial bits anyone can create to promote any real or fictional project they want, as long as they still respect the rest of the guidelines. Of course, with our size, you’re not promoting anything to a large group of people, but these guidelines will still apply if and when we grow bigger, and they’re here to keep the space fun and healthy for everyone.

## What they are not

Ads in CRSS content are not and will never be a space to advertise real products, such as server rentings or marketable plushies of your Minecraft skin. If you indirectly earn revenue from it, for example if you’re promoting a Modrinth Project, that’s completely fine – the issue is if your only intention is to profit from affiliate commissions and such.

## What to keep in mind

Here’s some things you should keep in mind when making your ad. These are *mostly* suggestions, you don’t have to follow them 1:1 as some step-by-step guide, your creativity is appreciated and encouraged\!

* Follow CRSS Content Guidelines *(obviously)*  
* Keep the ads somewhat short and entertaining  
...
As I said in ‘Brand Representation’:
...
[CRSS’ YouTube Channel](https://youtube.com/@crss666)  
[CRSS’ TikTok Profile](https://tiktok.com/@crss665)  
[CRSS’ Instagram Profile](https://instagram.com/crss.666)  
[CRSS’ Quartz News Network Spotify Podcast](https://open.spotify.com/show/4elAh0v7YQJKMwbZuQgRnr)  
[CRSS’ Bluesky Profile](https://bsky.app/profile/crss.cc)  
[CRSS Branding Repo](https://github.com/CRSS666/branding)  
(No access? @ blurry)
